...
if __name__ == "__main__":
    ...
    calls_df = preprocess_data(path_to_options_data, option_type='Put')
    ...
    torch.save(model_trained.state_dict(), './model_trained_put.pth')
    ...
    with open('results_put.json', 'w') as fp:
